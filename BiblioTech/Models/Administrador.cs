...
namespace BiblioTech.Models
{
    public class Administrador : Usuario
    {
        ...
        // Obtiene los detalles de acceso del administrador
        public string ObtenerDetallesAcceso()
        {
            string detalles = "Nivel: " + _nivelAcceso + " | Departamento: " + _departamento + 
                " | Desde: " + _fechaAsignacion.ToString("yyyy-MM-dd");
            return detalles;
        }
    }
}
